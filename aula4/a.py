...
def init():
    glClearColor(1, 1, 1, 1)  # Define a cor de fundo azul (R=0, G=0, B=1, A=1)
...
def draw():
    ...
    glColor3f(0, 0, 0)  # Define a cor do triângulo como amarelo (R=1, G=1, B=0)
    glVertex3f(-1, 3, 0)  # Define o vértice superior
    glVertex3f(-3, -3, 0)  # Define o vértice inferior esquerdo
    glVertex3f(3, -3, 0)  # Define o vértice inferior direito
